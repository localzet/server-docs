    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:url" content={`https://docs.localzet.com${router.asPath}`}/>
                ...
                <meta property="og:image"
                      content={`https://cover.pr-cy.io/api/og?logo=${encodeURIComponent('https://docs.localzet.com/favicon.png')}&bgColor=0f172a&color=E6E7E8&title=${encodeURIComponent(pageProps.title ?? 'Localzet Server')}&category=${encodeURIComponent('Документация - Localzet Server')}`}/>
                ...
                <link rel="alternate" hrefLang="ru" href={`https://docs.localzet.com${router.asPath}`}/>
                <link rel="alternate" hrefLang="en" href={`https://docs.localzet.com${router.asPath}`}/>
                <link rel="alternate" hrefLang="x-default" href={`https://docs.localzet.com${router.asPath}`}/>
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: (() => {
                            const currentUrl = `https://docs.localzet.com${router.asPath}`;
                            const breadcrumbItems = [{
                                "@type": "ListItem",
                                "position": 1,
                                "name": "Главная",
                                "item": "https://docs.localzet.com/"
                            }];
                            if (router.asPath !== '/') {
                                ...
                                "@graph": [
                                    {
                                        ...
                                        "@id": "https://docs.localzet.com/#software",
                                    ...
                                    {
                                        "@type": "WebSite",
                                        "@id": "https://docs.localzet.com/#website",
                                        "url": "https://docs.localzet.com",
                                        ...
                                        "publisher": {
                                            "@id": "https://docs.localzet.com/#organization"
                                        },
                                        "inLanguage": ["ru", "en"],
                                        "potentialAction": {
                                            "@type": "SearchAction",
                                            "target": {
                                                "@type": "EntryPoint",
                                                "urlTemplate": "https://docs.localzet.com?q={search_term_string}"
                                            },
                                    ...
                                    },
                                    {
                                        ...
                                        "logo": "https://docs.localzet.com/favicon.png"
                                    },
                                    {
                                        "@type": "TechArticle",
